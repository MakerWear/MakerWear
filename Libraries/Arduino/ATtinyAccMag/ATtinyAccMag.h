#ifndef ATtinyAccMag_h
#define ATtinyAccMag_h
...
*/
template <typename T> float ATtinyAccMag::heading(vector<T> from)
{
...
template <typename Ta, typename Tb, typename To> void ATtinyAccMag::vector_cross(const vector<Ta> *a, const vector<Tb> *b, vector<To> *out)
{
...
template <typename Ta, typename Tb> float ATtinyAccMag::vector_dot(const vector<Ta> *a, const vector<Tb> *b)
{
